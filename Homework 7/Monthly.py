...
# select prices at end of each month
myPrice = Price.groupby(by=[Price.index.year, Price.index.month]).tail(1)

# business dates at end of each month
mydates = myPrice.index

# monthly return
ret_Monthly = myPrice/myPrice.shift(1)-1

r_Monthly = myPrice.pct_change()


print(ret_Monthly.mean())

print(ret_Monthly.std())
...
ret_Monthly_percentage = ret_Monthly*100

fig, ax = plt.subplots()

ret_Monthly_percentage.plot(ax = ax)
